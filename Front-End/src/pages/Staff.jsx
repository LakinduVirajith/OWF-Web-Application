  ...
  return (
    <main className="container">
      <Helmet>
        ...
        <meta
          name="description"
          content="Meet the leadership and staff members of One World Foundation who are committed to providing free education and support to the community."
        />
        <meta
          name="keywords"
          content="One World Foundation Staff, Management Team, Education Staff, Sri Lanka NGO, Ahungalla"
        />
        ...
        <div className="staff-modal" onClick={() => setSelectedStaff(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`Photo of ${selectedStaff.name}`}
            />
            ...
            <p>
              <strong>Subject Taught:</strong> {selectedStaff.subjectTaught}
            </p>
            <p>
              <strong>Qualification:</strong> {selectedStaff.qualification}
            </p>
            <p>
              <strong>Service Start Date:</strong>{' '}
              {selectedStaff.serviceStartDate}
            </p>
            <p>
            ...
            <p>
              <strong>Bio:</strong> {selectedStaff.bio}
            </p>
          </div>
        </div>
      )}
