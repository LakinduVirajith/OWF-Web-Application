  ...
  return (
    <main className="container">
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about the One World Foundation, its mission, history, and free education initiatives in Ahungalla, Sri Lanka."
        />
        <meta
          name="keywords"
          content="One World Foundation, Free Education, Ahungalla, Sri Lanka, Vocational Training, Non-Profit, NGO"
        />
      ...
      {Object.keys(aboutData)
        ...
        .map((key) => (
          <p className="about-text" key={key}>
            {aboutData[key]}
          </p>
        ))}
    </main>
