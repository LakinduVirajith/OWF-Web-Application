  ...
  return (
    <main className="container">
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the Sports program at One World Foundation — promoting physical fitness, teamwork, and holistic development for youth in Ahungalla, Sri Lanka."
        />
        <meta
          name="keywords"
          content="Sports Program, Physical Education, Youth Development, One World Foundation, OWF, Sri Lanka NGO, Ahungalla, Free Sports Training"
        />
