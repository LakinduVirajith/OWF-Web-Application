    ...
    <main className="container">
      <Helmet>
        <title>Primary-Education | One World Foundation</title>
          <meta name="description" content="Explore our Primary-Education program at One World Foundation in Ahungalla, Sri Lanka — dedicated to providing early childhood education freely and with care." />
          <meta name="keywords" content="Primary-Education, Early Childhood Education, One World Foundation, Sri Lanka NGO, Ahungalla, Free Education, OWF Primary-Education" />
        ...
        {courseData.imageUrl && (
          <div className='primary-education-image-container'>
            <img
              ...
              alt={courseData.paragraph1?.slice(0, 50) || "primary-education image"}
