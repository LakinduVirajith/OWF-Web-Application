...
import '../../styles/courses/VocationalTrainingDetail.css';

function VocationalTrainingDetail() {
    ...
    const fetchCourseItem = async () => {
      try {
        const res = await fetch(
          `${backendApiUrl}/courses/vocational-training/details?id=${id}`
        );
      ...
      <div className="course-detail-section">
        ...
        {courseItem.imageUrl && (
          <div className="course-image-container">
            ...
            <button className="button-primary btn-full" onClick={formNavigate}>
              APPLY NOW
            </button>
          </div>
        )}
...
export default VocationalTrainingDetail;
