  ...
  return (
    <main className="container">
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore our Pre-School program at One World Foundation in Ahungalla, Sri Lanka — dedicated to providing early childhood education freely and with care."
        />
        <meta
          name="keywords"
          content="Pre-School, Early Childhood Education, One World Foundation, Sri Lanka NGO, Ahungalla, Free Education, OWF Pre-School"
        />
