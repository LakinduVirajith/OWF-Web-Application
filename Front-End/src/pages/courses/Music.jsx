  ...
  return (
    <main className="container">
      <Helmet>
        ...
        <meta
          name="description"
          content="Join the Music program at One World Foundation in Ahungalla, Sri Lanka — nurturing creativity, rhythm, and expression through free music education."
        />
        <meta
          name="keywords"
          content="Music Program, Music Education, Creative Arts, One World Foundation, OWF Music, Free Music Classes, Sri Lanka NGO, Ahungalla"
        />
